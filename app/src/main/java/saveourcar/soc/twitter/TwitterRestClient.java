...
public class TwitterRestClient extends BasicRestClient {
    ...
    private static final String CONSUMER_KEY = "wzO9YzNifIcvAnH15KNXS54ce";
    private static final String CONSUMER_SECRET = "EfXQxAyAW2Y02U0B67sLPA7ycsfOzB0KVzx8S4jjEb0z0ZKtCt";
